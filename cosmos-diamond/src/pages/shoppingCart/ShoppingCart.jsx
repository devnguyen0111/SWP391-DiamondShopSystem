...
import { Button, Card, Col, Divider, Flex, Row, Skeleton, Typography } from "antd";
import {
  DownOutlined,
  MessageOutlined,
  PhoneOutlined,
      ...
      <div>
        ...
        >
          ...
          {cart && token && cart.items.$values.length > 0 ? (
            isLoading ? <Col style={{marginTop:'48px'}} span={12} md={6} sm={24}><Skeleton/></Col> :<Col span={12} md={6} sm={24}>
